...
<div class="fixed z-10 inset-0 overflow-y-auto" x-data="{show : true}" x-transition x-show="show" x-init="setTimeout(() => show = false , 3000)">
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="sm:flex sm:items-start">
            ...
            <!-- Icon -->
            <div class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-laravel-100 sm:mx-0 sm:h-10 sm:w-10">
